...
@section('content')
    ...
    <div class="w-4/5 pt-7 mx-auto">
        ...
        <h1 class="text-4xl pb-7">個人情報保護方針</h1>
        <p class="font-thin text-xs mb-7">
            Anovey（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
        </p>
        ...
        <ol class="font-thin text-xs mb-7">
            <li>担当者： 遠竹悠
            </li>
            <li>Eメールアドレス：example@gmail.com</li>
        </ol>
    </div>
