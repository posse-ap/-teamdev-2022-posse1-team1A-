...
@section('content')
    ...
    <div class="w-4/5 pt-7 mx-auto">
        ...
        <p class="font-thin text-xs mb-7">
            この利用規約（以下，「本規約」といいます。）は，Anovey（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        ...
        <p class="list-decimal font-thin text-xs mb-7">
        ...
        <p class="list-decimal font-thin text-xs mb-7">当社は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
        </p>
