                    ...
                    <div class="user flex items-center text-center flex-col sm:flex-row sm:text-left">
                        ...
                        <div class="user-body flex flex-col mb-4 sm:mb-0 sm:mr-4 pl-4">
                            <div class="skills flex flex-col">
                                <span class="subtitle mb-3 text-xl">{{ $chatRoom->respondent_user_name }}</span>
                                {{-- <span class="subtitle text-xs font-normal">{{ dd($chatRoom->newestChatRecord) }}</span> --}}
                                <span class="subtitle text-xs font-normal box-read">{{ $chatRoom->newestChatRecord->comment }}</span>
                            </div>
                        </div>
                    </div>
                    <!--Button content -->
                    <div class="user-option mx-auto sm:ml-auto sm:mr-0">
                        <span class="text-xs">相談日程 {{ $chatRoom->schedule }}~</span>
