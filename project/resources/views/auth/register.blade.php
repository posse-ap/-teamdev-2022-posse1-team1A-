        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="md:grid md:grid-cols-4 md:gap-2 px-5 mb-9">
                ...
                <div class="col-span-4">
                    <input class="mb-2 rounded-md bg-lightgray-200 shadow-sm border-gray-300 border-gray-300 w-full" type="text" name="name" id="">
            ...
            <div class="md:grid md:grid-cols-4 md:gap-2 px-5 mb-9">
                ...
                <div class="col-span-4">
                    <input class="mb-2 bg-lightgray-200 rounded-md bg-lightgray-200 w-full" type="text" name="nickname" id="">
            ...
            <div class="md:grid md:grid-cols-4 md:gap-2 px-5 mb-9">
                ...
                <input class="rounded-md bg-lightgray-200 bg-lightgray-200 col-span-4 w-full" type="email" name="email" id="">
            </div>
            {{-- company --}}
            <div class="md:grid md:grid-cols-4 md:gap-2 px-5 mb-9">
